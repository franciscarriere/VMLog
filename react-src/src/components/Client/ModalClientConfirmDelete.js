...
class ModalClientConfirmDelete extends Component {
  ...
  render() {
    return (
      ...
      >
        ...
        <Modal.Actions>
          <Button onClick={this.handleSubmit} data-clientID={this.props.client._id} color='red'>Yes</Button>
...
export default ModalClientConfirmDelete;
